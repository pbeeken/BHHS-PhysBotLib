...
//
//****************************************************************************//
PhysBotSensorBar::PhysBotSensorBar(uint8_t address, uint8_t resetPin, uint8_t interruptPin, uint8_t oscillatorPin)
{
...
void PhysBotSensorBar::debounceConfig(uint8_t configValue)
{
...
void PhysBotSensorBar::debounceEnable(uint8_t pin)
{
...
uint8_t PhysBotSensorBar::begin(void)
{
  uint8_t returnVar = 0;
  if (pinInterrupt != 255)
  {
...
//Do a software reset
void PhysBotSensorBar::reset( void )
{
...
void PhysBotSensorBar::enableInterrupt(uint8_t pin, uint8_t riseFall)
{
...
unsigned int PhysBotSensorBar::interruptSource(void)
{
...
void PhysBotSensorBar::configClock(uint8_t oscSource, uint8_t oscPinFunction, uint8_t oscFreqOut, uint8_t oscDivider)
{
...
uint8_t PhysBotSensorBar::getRaw( void )
{
...
int8_t PhysBotSensorBar::getPosition( void )
{
...
uint8_t PhysBotSensorBar::getDensity( void )
{
  uint8_t bitsCounted = 0;
  uint8_t i;
...
//
//****************************************************************************//
void PhysBotSensorBar::scan( void )
{
  if( barStrobe == 1 )
  {
...
//
uint8_t PhysBotSensorBar::readByte(uint8_t registerAddress)
{
  uint8_t readValue;
...
unsigned int PhysBotSensorBar::readWord(uint8_t registerAddress)
{
...
//	- No return value.
void PhysBotSensorBar::readBytes(uint8_t firstRegisterAddress, uint8_t * destination, uint8_t length)
{
  uint8_t readValue;
...
//	- No return value.
void PhysBotSensorBar::writeByte(uint8_t registerAddress, uint8_t writeValue)
{
  Wire.beginTransmission(deviceAddress);
  Wire.write(registerAddress);
...
//	- No return value.
void PhysBotSensorBar::writeWord(uint8_t registerAddress, unsigned int writeValue)
{
  uint8_t msb, lsb;
...
//	- no return value.
void PhysBotSensorBar::writeBytes(uint8_t firstRegisterAddress, uint8_t * writeArray, uint8_t length)
{
  Wire.beginTransmission(deviceAddress);
  Wire.write(firstRegisterAddress);
  for (int i = 0; i < length; i++)
